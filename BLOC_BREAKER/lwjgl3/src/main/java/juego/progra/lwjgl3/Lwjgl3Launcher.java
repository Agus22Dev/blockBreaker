package juego.progra.lwjgl3;

import com.badlogic.gdx.backends.lwjgl3.Lwjgl3Application;
import com.badlogic.gdx.backends.lwjgl3.Lwjgl3ApplicationConfiguration;
import juego.progra.BlockBreakerGame;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("Block Breaker");
        //// Vsync limits the frames per second to what your hardware can display, and helps eliminate
        //// screen tearing. This setting doesn't always work on Linux, so the line after is a safeguard.
        configuration.useVsync(true);
        //// Limits FPS to 60 for smoother and more controlled gameplay
        configuration.setForegroundFPS(60);
        //// If you remove the above line and set Vsync to false, you can get unlimited FPS, which can be
        //// useful for testing performance, but can also be very stressful to some hardware.
        //// You may also need to configure GPU drivers to fully disable Vsync; this can cause screen tearing.

        //// Configuración de ventana: tamaño inicial y no redimensionable
        configuration.setWindowedMode(800, 480);
        configuration.setResizable(false); // Ventana NO redimensionable
